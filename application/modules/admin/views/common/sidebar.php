                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-group"></i>Manage Master<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="<?php echo site_url();?>/admin/stateList">State</a></li>
                      <li><a href="<?php echo site_url();?>/admin/cityList">City</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-group"></i>Vendor<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo site_url();?>/admin/vendorList">View Vendors</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-group"></i>User<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo site_url();?>/admin/userList">View User</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-group"></i>Hotels<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo site_url();?>/admin/hotelList">View Hotels</a></li>
                    </ul>
                  </li>
				  </ul>
              </div>
